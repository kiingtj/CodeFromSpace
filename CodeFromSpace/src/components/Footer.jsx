      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-10">
          ...
          <div className="flex justify-center lg:justify-start gap-4 mt-6">
            <a href="#">
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-current hover:text-rosa"
              >
        ...
        <div className="flex flex-wrap justify-center lg:justify-end gap-10 w-full lg:w-[65%]">
          <div className="flex flex-col gap-2 text-center lg:text-left">
            ...
            <a href="#xxx" className="hover:underline hover:text-rosa">About Us</a>
            <a href="#xxx" className="hover:underline hover:text-rosa">Contact</a>
            <a href="#xxx" className="hover:underline hover:text-rosa">Support</a>
            <a href="#xxx" className="hover:underline hover:text-rosa">News</a>
          </div>
          <div className="flex flex-col gap-2 text-center lg:text-left">
            <div className="font-bold uppercase text-[#d9d9d9] pb-3">Legal</div>
            <a href="#xxx" className="hover:underline hover:text-rosa">Imprint</a>
            <a href="#xxx" className="hover:underline hover:text-rosa">Privacy Policy</a>
            <a href="#xxx" className="hover:underline hover:text-rosa">Terms of Use</a>
          </div>
        </div>
      </div>
      {/* Línea divisoria */}
